...
class EdithClockFrauncesFaceController(
    ...
    private val digitViews =
        mutableListOf<Pair<EdithClockFrauncesTextView, DigitalTimespecHandler>>()

    private val smallView: EdithClockFrauncesTextView?
    private val largeGroup: EdithClockFrauncesViewGroup?
    ...
    init {
        if (isLargeClock) {
            smallView = null
            val group =
                EdithClockFrauncesViewGroup(clockCtx).apply {
            ...
            largeGroup = null
            val textView =
                EdithClockFrauncesTextView(clockCtx).apply {
    ...
    ): EdithClockFrauncesTextView {
        val handler = DigitalTimespecHandler(timespec, formatter)
        return EdithClockFrauncesTextView(clockCtx).apply {
    ...
    override val events =
        object : ClockFaceEvents {
            ...
            override fun onThemeChanged(theme: ThemeConfig) {
                this@EdithClockFrauncesFaceController.theme = theme
